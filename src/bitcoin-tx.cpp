...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s trannychain-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  trannychain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded trannychain transaction") + "\n" +
              "  trannychain-tx [options] -create [commands]   " + _("Create hex-encoded trannychain transaction") + "\n" +
              "\n";
