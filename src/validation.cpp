...
#if defined(NDEBUG)
# error "Trannychain cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Trannychain Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s TRANNY additional fees, %d delta bytes\n",
