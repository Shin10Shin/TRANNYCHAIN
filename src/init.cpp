...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/trannychain-project/trannychain>";
    const std::string URL_WEBSITE = "<https://trannychain.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Trannychain version %s\n", FormatFullVersion());
}
